...
pub use repos::{
    ...
    DivergenceRepository, EdgeEncryptionRepository, EdgeEncryptionRow, EdgeRepository, EgoEdgeRow,
    EgoEdges, EgoEntity, EgoRepository, EntityRepository, EntityRow, EntityTypeEntry,
