...
pub use repos::{
    ...
    AnalysisRepository, BehavioralExecutionRepository, BehavioralExecutionRow,
    CanonicalBackfillChunk, ChallengeRepository, ChallengeRow, ClaimBeliefColumns, ClaimDispute,
    ClaimEmbeddingHit, ClaimEncryptionRepository, ClaimEncryptionRow, ClaimNeighbor,
    ...
    StepDeviationRow, SweepCandidate, TaskRepository, TaskRow, TripleRepository, TripleRow,
