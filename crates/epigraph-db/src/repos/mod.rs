...
pub use claim::{
    ...
    ConsolidateResult, DedupRepair, EvolveStepResult, GraphExpansionHit, HybridHit, LineageHead,
    NearestClaimHit, PatchClaimDiff, PatchClaimInput, SweepCandidate, CONSOLIDATE_MAX_SOURCES,
...
pub use evidence::{EvidenceListFilter, EvidenceListRow, EvidenceRepository, EvidenceSearchResult};
pub use experiment::{
